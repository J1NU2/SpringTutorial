...
public class FileDataUtil {
	...
	@Resource(name = "uploadPath")		// 컨테이너로부터 주입받는다. 이름으로 주입받겠다는 의미
	private String uploadPath;			// 해당 변수의 의미, 첨부파일의 위치 지정
	// 위치가 필요한데 개발자가 직접 작성하는 것이 아닌 스프링 컨테이너로부터 자동으로 가져온다.
	 ...
	 */
	// @ResponseBody를 쓴 이유
	// 리턴타입이 view의 이름이 아닌 파일 자체를 의미하도록 설정
